...
The code is free for research purposes or personal use.
...
Jun-Hao Wang, Yi-Yang Tian, [Baoquan Chen](https://baoquanchen.info/), [Peng-Shuai Wang](https://wang-ps.github.io/)</br>
SIGGRAPH Asia 2025
![teaser](teaser.jpg)
...
2.3 Evaluate the model by:
   ```
   python train.py --config vis_shapenet.yaml SOLVER.gpu 0,  \
          SOLVER.run test DATA.test.takes [num-of-points]
   ```
...
3.4 Run the User Interface (UI) script.
